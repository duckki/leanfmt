...
retains its delimiter-owned source layout. Delimiter and `where` proof-layout islands
likewise retain their established first-token anchor so their fields do not drift with a
moved header.
